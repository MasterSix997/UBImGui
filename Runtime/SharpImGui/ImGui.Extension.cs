...
namespace SharpImGui
{
    public static unsafe partial class ImGui
    {
            ...
            IntPtr user_data)
        {
            ...
            byte result = ImGuiNative.ImGui_InputTextEx(
                utf8LabelBytes,
                utf8InputBytes,
                (uint)inputBufSize,
                flags,
            ...
            IntPtr user_data)
        {
            ...
            byte result = ImGuiNative.ImGui_InputTextMultilineEx(
                utf8LabelBytes,
                utf8InputBytes,
                (uint)inputBufSize,
                size,
            ...
            IntPtr user_data)
        {
            ...
            byte result = ImGuiNative.ImGui_InputTextWithHintEx(
                utf8LabelBytes,
                utf8HintBytes,
                utf8InputBytes,
                (uint)inputBufSize,
        ...
        {
            return CalcTextSize(text, start, length ?? text.Length - start, hideTextAfterDoubleHash, wrapWidth);
        }
            ...
            IntPtr user_data)
        {
            ...
            bool ret = ImGuiNative.ImGui_InputTextEx(utf8LabelBytes, (byte*)buf.ToPointer(), buf_size, flags, callback, user_data.ToPointer()) != 0;
